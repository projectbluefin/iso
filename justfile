...
iso-sd-boot target:
    ...
    _ns "
        ...
        ns_cleanup() {
            umount \"\${SQUASHFS_ROOT}/var/lib/containers/storage-additional\" 2>/dev/null || true
        ...
        SQUASHFS_STORAGE=\"\${CS_STAGING}/var/lib/containers/storage-additional\"
        ...
        mkdir -p \"\${SQUASHFS_ROOT}/var/lib/containers/storage-additional\"
        mount --bind \"\${CS_STAGING}/var/lib/containers/storage-additional\" \"\${SQUASHFS_ROOT}/var/lib/containers/storage-additional\"
...
luks-install target:
    ...
    echo "Running fisherman install (pulls from registry, takes several minutes)..."
